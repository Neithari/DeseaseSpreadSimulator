...
DeseaseSpreadSimulation::PersonBehavior::PersonBehavior(uint16_t foodBuyInterval, uint16_t hardwareBuyInterval, float acceptanceFactor)
	:
...
DeseaseSpreadSimulation::PersonBehavior::PersonBehavior()
{
	...
	static constexpr std::array<float, 7> intervals{ 0.f, .2f, .6f, .7f, .8f, .9f, 1.f };
	static constexpr std::array<float, 6> weights{ 1.f, 0.f, 10.f, 10.f, 29.f, 50.f };
